...
public class DetailController_lostLuggage extends BaseClass implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        titleReplaced = title.getText().replace("00", String.valueOf(idLostLuggage));
